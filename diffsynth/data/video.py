...
def crop_and_resize(image, height, width):
    # WorldCam resizes directly (no center crop) so the image grid stays
    # aligned with the Plücker embedding used by the camera-conditioned DiT.
...
def merge_video_audio(video_path: str, audio_path: str):
    ...
    and overwrite the original video file. Requires `ffmpeg` on the PATH.
